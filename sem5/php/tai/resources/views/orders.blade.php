...
<body>
    ...
    <div class="table-container">
        ...
        <table data-toggle="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$order->message}}
                        <br /> @if($order->user_id == \Auth::user()->id)
                        <a href="{{ route('edit', $comment) }}" class="btn btn-success btn-xs" title="Edytuj"> Edytuj </a>
        ...
        <div class="footer-button">
            <a href="{{ route('createorders') }}" class="btn btn-secondary">Dodaj</a>
        </div>
