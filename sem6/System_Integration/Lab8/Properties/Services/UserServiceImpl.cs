...
public class UserServiceImpl : IUserService
{
    ...
    IEnumerable<WebApplication.Entities.User> IUserService.GetUsers()
    {
        throw new NotImplementedException();
    }

    WebApplication.Entities.User IUserService.GetByUsername(string username)
    {
        throw new NotImplementedException();
    }

    WebApplication.Entities.User IUserService.GetById(int id)
    {
        throw new NotImplementedException();
    }

    public object Authenticate(WebApplication.Services.AuthenticationRequest request)
    {
        throw new NotImplementedException();
    }
}
